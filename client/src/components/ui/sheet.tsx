...
const SheetContent = React.forwardRef<
  ...
  SheetContentProps
>(({ side = "right", className: propClassName, children, ...props }, ref) => ( // Renamed className to propClassName
  <SheetPortal>
    <SheetOverlay />
    <SheetPrimitive.Content
      ref={ref}
      className={cn(sheetVariants({ side }), propClassName)} // Used propClassName here
      {...props}
    >
      {children}
